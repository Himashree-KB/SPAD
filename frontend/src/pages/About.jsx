    ...
    <main className="bg-[#FBFFF1] min-h-screen">
      ...
      <section className="pt-28 pb-20 max-w-7xl mx-auto px-6">
        <div className="text-left">
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-bold leading-tight text-[#000100]"
          >
            About <span className="text-[#0000F5]">Us</span>
          </motion.h1>
          <motion.p
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="mt-6 text-lg text-[#000100]/90 max-w-3xl"
          >
      ...
      <Section title="Governance" imageLeft={false} bg={false}>
        <p className="text-lg text-[#000100]/90 leading-relaxed">
          ...
          The Chief Functionary holds final accountability. Managers oversee projects
      ...
      <Section title="Project Team" imageLeft={true} bg={true}>
        <p className="text-lg text-[#000100]/90 leading-relaxed">
          The senior project team includes 3 members with postgraduate degrees in Social Work
          and over 90 years of combined experience. SPAD’s team of 24 includes Project Directors,
          Managers, Counsellors, Outreach Workers, Nurses, Doctors, Accounts and Office staff.
        </p>
      </Section>
